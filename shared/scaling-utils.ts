/**
 * Shared scaling utilities for mind map components
 * Provides consistent responsive scaling across web and mobile platforms
 */
...
export function calculateResponsiveScale(
  ...
  return {
    ...
    gridSize: Math.round(config.baseGridSize * finalScale),
